...
# agents/decider.md, or the agents-opencode/ twins change, then bump the
# changed agent's `version` in crew-bundle/manifest.json so installed copies
# show "Update available" after the app syncs.
#
# Usage:
