---
description: >-
  Read-only review subagent that walks a card's diff for common defects and
  reports findings grouped by severity. Delegated to by a pipeline's review
  stage. Does not edit code or propose fixes unless asked — it reports. Cites
